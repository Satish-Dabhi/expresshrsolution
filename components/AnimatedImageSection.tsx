...
export default function AnimatedImageSection({
  ...
  /* --------------------------------------------------------
     2) Typewriter effect (title first, then subtitle)
  -------------------------------------------------------- */
  useEffect(() => {
  ...
  /* --------------------------------------------------------
     3) Start Framer Motion mask animation
  -------------------------------------------------------- */
  useEffect(() => {
    if (shouldAnimate) {
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl overflow-hidden" style={{ height }}>
        ...
        >
          <svg width="950" height="180" viewBox="0 0 893 183" fill="none">
            <path
        ...
        >
          {/* Title */}
          <h2 className={`text-3xl md:text-5xl lg:text-6xl font-semibold leading-tight mb-4 mt-[${titleMarginTop}]`}>
            {typedTitle}
          </h2>
